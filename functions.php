...
function my_gettext2($translated_text, $text, $domain) {
	$translated_text = str_replace('数量', '人数', $translated_text);
	return $translated_text;
}
function my_gettext3($translated_text, $text, $domain) {
	$translated_text = str_replace('注文する', '支払う', $translated_text);
	return $translated_text;
}
function my_gettext4($translated_text, $text, $domain) {
	$translated_text = str_replace('商品', '受講レッスン', $translated_text);
	return $translated_text;
}
function my_gettext5($translated_text, $text, $domain) {
	$translated_text = str_replace('ご注文', 'お申込みレッスン一覧', $translated_text);
	return $translated_text;
}
function my_gettext6($translated_text, $text, $domain) {
	$translated_text = str_replace('注文を完了しました', '申込みを完了しました', $translated_text);
	return $translated_text;
}
function my_gettext7($translated_text, $text, $domain) {
	$translated_text = str_replace('注文詳細', '申込詳細', $translated_text);
	return $translated_text;
}
function my_gettext8($translated_text, $text, $domain) {
	$translated_text = str_replace('ショップに戻る', 'レッスン一覧に戻る', $translated_text);
	return $translated_text;
}
function my_gettext9($translated_text, $text, $domain) {
	$translated_text = str_replace('注文番号', '申込番号', $translated_text);
	return $translated_text;
}
function my_gettext10($translated_text, $text, $domain) {
	$translated_text = str_replace('お申込みリストを表示', '<br>お申込みリストを表示', $translated_text);
	return $translated_text;
}
function my_gettext11($translated_text, $text, $domain) {
	$translated_text = str_replace('ショップに戻る', 'レッスン一覧に戻る', $translated_text);
	return $translated_text;
}
add_filter('gettext', 'my_gettext1', 10, 3);
add_filter('gettext', 'my_gettext2', 10, 3);
add_filter('gettext', 'my_gettext3', 10, 3);
add_filter('gettext', 'my_gettext4', 10, 3);
add_filter('gettext', 'my_gettext5', 10, 3);
add_filter('gettext', 'my_gettext6', 10, 3);
add_filter('gettext', 'my_gettext7', 10, 3);
add_filter('gettext', 'my_gettext8', 10, 3);
add_filter('gettext', 'my_gettext9', 10, 3);
add_filter('gettext', 'my_gettext10', 10, 3);
add_filter('gettext', 'my_gettext11', 10, 3);
